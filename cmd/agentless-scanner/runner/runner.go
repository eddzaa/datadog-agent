...
func New(opts Options) (*Runner, error) {
	...
	eventForwarder := optional.NewOptionPtr[eventplatform.Forwarder](eventplatformimpl.NewNoopEventPlatformForwarder(hostnameimpl.NewHostnameService()))
	...
	rcClient, err := client.NewUnverifiedGRPCClient(ipcAddress, config.GetIPCPort(),
		...
		client.WithProducts(state.ProductCSMSideScanning),
