...
// NewTCPEndpoint returns a new TCP  Endpoint based on LogsConfigKeys
...
// NewHTTPEndpoint returns a new HTTP  Endpoint based on LogsConfigKeys
...
// GetAPIKey returns the API for the Endpoint.
