...
type enrichConfig struct {
	...
	unifiedOriginDetectionEnabled bool
	serverlessMode                bool
...
func extractTagsMetadata(tags []string, originFromUDS string, originFromMsg []byte, conf enrichConfig) ([]string, string, taggertypes.OriginInfo, metrics.MetricSource) {
	...
	origin := taggertypes.OriginInfo{FromUDS: originFromUDS, FromMsg: string(originFromMsg), ProductOrigin: taggertypes.ProductOriginDogStatsD}
